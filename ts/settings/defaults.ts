export class Settings {
    ...
    /* Ajustes del mapa */
    public static readonly mapFontFamily = 'Arial';

    /* Colores del mapa */
    public static readonly buildingColor = '#90A4AE';
    public static readonly strokeColor = '#455A64';
    public static readonly textColor = '#0C0C0C';
    public static readonly backgroundColor = '#ECEFF1';
    ...
    public static readonly routeHighlightColor = '#2236FF';
